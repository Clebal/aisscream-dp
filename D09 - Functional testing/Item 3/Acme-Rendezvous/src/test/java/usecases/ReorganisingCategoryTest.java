...
public class ReorganisingCategoryTest extends AbstractTest {
	...
	//Pruebas
	/*
	 * 1. Reorganizar Category sin padre y sin hijos, a una Category padre sin padre y sin hijos. Excepción no esperada.
	 * 2. Reorganizar Category sin padre y con hijos, a una Category padre sin padre y sin hijos. Excepción no esperada.
	 * 3. Reorganizar Category con padre y sin hijos, a una Category padre sin padre y sin hijos. Excepción no esperada.
	 * 4. Reorganizar Category con padre y con hijos, a una Category padre sin padre y sin hijos. Excepción no esperada.
	 */
	...
	//Pruebas
	/*
	 * 1. Reorganizar Category sin padre y sin hijos, a una Category padre sin padre y con hijos. Excepción no esperada.
	 * 2. Reorganizar Category sin padre y con hijos, a una Category padre sin padre y con hijos. Excepción no esperada.
	 * 3. Reorganizar Category con padre y sin hijos, a una Category padre sin padre y con hijos. Excepción no esperada.
	 * 4. Reorganizar Category con padre y con hijos, a una Category padre sin padre y con hijos. Excepción no esperada.
	 */
	...
	//Pruebas
	/*
	 * 1. Reorganizar Category sin padre y sin hijos, a una Category padre con padre y sin hijos. Excepción no esperada.
	 * 2. Reorganizar Category sin padre y con hijos, a una Category padre con padre y sin hijos. Excepción no esperada.
	 * 3. Reorganizar Category con padre y sin hijos, a una Category padre con padre y sin hijos. Excepción no esperada.
	 * 4. Reorganizar Category con padre y con hijos, a una Category padre con padre y sin hijos. Excepción no esperada.
	 */
	...
	//Pruebas
	/*
	 * 1. Reorganizar Category sin padre y sin hijos, a una Category padre con padre y con hijos. Excepción no esperada.
	 * 2. Reorganizar Category sin padre y con hijos, a una Category padre con padre y con hijos. Excepción no esperada.
	 * 3. Reorganizar Category con padre y sin hijos, a una Category padre con padre y con hijos. Excepción no esperada.
	 * 4. Reorganizar Category con padre y con hijos, a una Category padre con padre y con hijos. Excepción no esperada.
	 */
	...
	//Pruebas
	/*
	 * 1. Reorganizar Category colocándola en la raíz sin hijos. Excepción no esperada.
	 ...
	 * 6. Reorganizar Category colocándola en la raíz con hijos. Excepción no esperada.
	 * 7. Reorganizar default Category. Excepción IllegalArgumentException esperada.
	 */
