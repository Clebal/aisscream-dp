		...
		final Object testingData[][] = {
				{
					...
					"user5", "Ya poco hay que contar", dateBad, "Ni voy a resumir", "Se acabó lo que se acaba", "http://entertainment.ie//images_content/rectangle/620x372/E-T.jpg", false, true, "user5", "newspaper4", ConstraintViolationException.class
				}
			};
