...
<jstl:if test="${role.equals('user')}">
	...
	<!-- FALLO INTENCIONADO -->
	<p><a href="actor/user/followers.do"><spring:message code="chirp.numberFollowers" />: ${countFollowers+1}</a> | <a href="actor/user/followeds.do"><spring:message code="chirp.numberFolloweds" />: ${countFolloweds}</a></p>
