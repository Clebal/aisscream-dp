		...
		final Object testingData[][] = {
			{
				...
				"admin", "administrator", "user50", "admin", "Gostin", "Perez", "", "Calle User NÂº41", dateGood, "gostin@mail.com", IllegalArgumentException.class 
			}, {
				"admin", "administrator", "admin", "manager", "Gostin", "Perez", "", "Calle User NÂº41", dateGood, "gostin@mail.com", IllegalArgumentException.class 
			},
		};
